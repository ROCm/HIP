...
macro(HIT_ADD_FILES _dir _label _parent)
    foreach (file ${ARGN})
        ...
        foreach(_cmd ${_contents})
            ...
            if(_exclude_platforms STREQUAL "all" OR _exclude_platforms STREQUAL ${HIP_PLATFORM} OR (_exclude_runtime STREQUAL ${HIP_RUNTIME} AND (NOT _exclude_compiler OR _exclude_compiler STREQUAL ${HIP_COMPILER})))
        ...
        foreach(_cmd ${_contents})
            ...
            if(_exclude_platforms STREQUAL "all" OR _exclude_platforms STREQUAL ${HIP_PLATFORM} OR
              (_exclude_runtime STREQUAL ${HIP_RUNTIME} AND (NOT _exclude_compiler OR _exclude_compiler STREQUAL ${HIP_COMPILER})) OR
              _exclude_test_from_build STREQUAL TRUE)
            else()
        ...
        foreach(_cmd ${_contents})
            ...
            string(REGEX REPLACE "/" "." target ${_label}/${_target})
            read_from_map("_exclude" "${target}" _exclude_test_from_build)
            if(_exclude_platforms STREQUAL "all" OR _exclude_platforms STREQUAL ${HIP_PLATFORM} OR (_exclude_runtime STREQUAL ${HIP_RUNTIME} AND (NOT _exclude_compiler OR _exclude_compiler STREQUAL ${HIP_COMPILER})) OR _exclude_test_from_build STREQUAL TRUE)
            else()
