...
macro(HIT_ADD_FILES _dir _label _parent)
    foreach (file ${ARGN})
        ...
        foreach(_cmd ${_contents})
            ...
            set(_exclude_platforms_found FALSE)
            foreach(_exclude ${_exclude_platforms})
                if(_exclude STREQUAL "all" OR _exclude STREQUAL ${HIP_PLATFORM} OR _exclude STREQUAL ${HIP_COMPILER})
                    set(_exclude_platforms_found TRUE)
                endif()
            endforeach()
            if(_exclude_platforms_found STREQUAL FALSE)
        ...
        foreach(_cmd ${_contents})
            ...
            set(_exclude_platforms_build_found FALSE)
            foreach(_exclude ${_exclude_platforms_from_build})
                if(_exclude STREQUAL "all" OR _exclude STREQUAL ${HIP_PLATFORM} OR _exclude STREQUAL ${HIP_COMPILER})
                    set(_exclude_platforms_build_found TRUE)
                endif()
            endforeach()

            if(_exclude_platforms STREQUAL "all" OR _exclude_platforms STREQUAL ${HIP_PLATFORM} OR
                    _exclude_platforms_build_found STREQUAL "TRUE")
            else()
