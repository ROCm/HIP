...
cout<<"The output of hipMemcpy(ptr0,str,100,hipMemcpyHostToDevice) is: "<<out<<endl;

out=hipGetErrorString(hipMemcpy(ptr1,ptr0,100, hipMemcpyDeviceToDevice));
cout<<"The output of hipMemcpy(ptr1,ptr0,100,hipMemcpyDeviceToDevice) is: "<<out<<endl;

out=hipGetErrorString(hipMemcpy(ptr1,ptr0,100, hipMemcpyHostToDevice));
cout<<"The output of hipMemcpy(ptr1,ptr0,100,hipMemcpyHostToDevice) is: "<<out<<endl;
