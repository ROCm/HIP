...
Tests for HIP are hosted at [ROCm-Developer-Tools/hip-tests](https://github.com/ROCm/hip-tests).
...
### Presubmit Testing:
Before checking in or submitting a pull request, run all hip-tests (see [ROCm-Developer-Tools/hip-tests](https://github.com/ROCm/hip-tests)).
