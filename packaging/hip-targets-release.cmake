...
set_target_properties(hip::hip_hcc_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${HIP_ROOT_DIR}/../lib/libhip_hcc_static.a"
  )
else()
set_target_properties(hip::hip_hcc_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
...
list(APPEND _IMPORT_CHECK_FILES_FOR_hip::hip_hcc_static "${HIP_ROOT_DIR}/../lib/libhip_hcc_static.a" )
...
set_target_properties(hip::hip_hcc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${HIP_ROOT_DIR/../lib/libhip_hcc.so"
  IMPORTED_SONAME_RELEASE "libhip_hcc.so"
  )
else()
set_target_properties(hip::hip_hcc PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "hcc::hccrt;hcc::hc_am"
  IMPORTED_LOCATION_RELEASE "${HIP_ROOT_DIR}/../hip/lib/libhip_hcc.so"
  IMPORTED_SONAME_RELEASE "libhip_hcc.so"
  )
endif()

list(APPEND _IMPORT_CHECK_TARGETS hip::hip_hcc )
list(APPEND _IMPORT_CHECK_FILES_FOR_hip::hip_hcc "${HIP_ROOT_DIR}/../hip/lib/libhip_hcc.so" )
