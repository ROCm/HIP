...
enum hip_cb_id_t {
  ...
  HIP_API_ID_hipMemcpyFromSymbolAsync = 8,
  HIP_API_ID_hipMemcpy2DToArray = 9,
  HIP_API_ID_hipCtxGetCacheConfig = 10,
  HIP_API_ID_hipStreamWaitEvent = 11,
  HIP_API_ID_hipModuleLoad = 12,
  HIP_API_ID_hipDevicePrimaryCtxSetFlags = 13,
  HIP_API_ID_hipMemcpyAsync = 14,
  HIP_API_ID_hipMalloc3DArray = 15,
  HIP_API_ID_hipStreamCreate = 16,
  HIP_API_ID_hipCtxGetCurrent = 17,
  HIP_API_ID_hipDevicePrimaryCtxGetState = 18,
  HIP_API_ID_hipEventQuery = 19,
  HIP_API_ID_hipEventCreate = 20,
  HIP_API_ID_hipMemGetAddressRange = 21,
  HIP_API_ID_hipMemcpyFromSymbol = 22,
  HIP_API_ID_hipArrayCreate = 23,
  HIP_API_ID_hipStreamGetFlags = 24,
  HIP_API_ID_hipMallocArray = 25,
  HIP_API_ID_hipCtxGetSharedMemConfig = 26,
  HIP_API_ID_hipMemPtrGetInfo = 27,
  HIP_API_ID_hipCtxGetFlags = 28,
  HIP_API_ID_hipStreamDestroy = 29,
  HIP_API_ID_hipMemcpy3D = 30,
  HIP_API_ID_hipInit = 31,
  HIP_API_ID_hipMemcpyAtoH = 32,
  HIP_API_ID_hipMemset2D = 33,
  HIP_API_ID_hipDeviceCanAccessPeer = 34,
  HIP_API_ID_hipDeviceEnablePeerAccess = 35,
  HIP_API_ID_hipModuleUnload = 36,
  HIP_API_ID_hipHostUnregister = 37,
  HIP_API_ID_hipProfilerStop = 38,
  HIP_API_ID_hipStreamSynchronize = 39,
  HIP_API_ID_hipFreeHost = 40,
  HIP_API_ID_hipDeviceSetCacheConfig = 41,
  HIP_API_ID_hipCtxGetApiVersion = 42,
  HIP_API_ID_hipMemcpyHtoD = 43,
  HIP_API_ID_hipModuleGetGlobal = 44,
  HIP_API_ID_hipMemcpyHtoA = 45,
  HIP_API_ID_hipCtxCreate = 46,
  HIP_API_ID_hipMemcpy2D = 47,
  HIP_API_ID_hipIpcCloseMemHandle = 48,
  HIP_API_ID_hipChooseDevice = 49,
  HIP_API_ID_hipDeviceSetSharedMemConfig = 50,
  HIP_API_ID_hipDeviceComputeCapability = 51,
  HIP_API_ID_hipDeviceGet = 52,
  HIP_API_ID_hipProfilerStart = 53,
  HIP_API_ID_hipCtxSetCacheConfig = 54,
  HIP_API_ID_hipFuncSetCacheConfig = 55,
  HIP_API_ID_hipMemcpyPeerAsync = 56,
  HIP_API_ID_hipEventElapsedTime = 57,
  HIP_API_ID_hipDevicePrimaryCtxReset = 58,
  HIP_API_ID_hipEventDestroy = 59,
  HIP_API_ID_hipCtxPopCurrent = 60,
  HIP_API_ID_hipHostGetFlags = 61,
  HIP_API_ID_hipHostMalloc = 62,
  HIP_API_ID_hipDriverGetVersion = 63,
  HIP_API_ID_hipMemGetInfo = 64,
  HIP_API_ID_hipDeviceReset = 65,
  HIP_API_ID_hipMemset = 66,
  HIP_API_ID_hipMemsetD8 = 67,
  HIP_API_ID_hipHostRegister = 68,
  HIP_API_ID_hipCtxSetSharedMemConfig = 69,
  HIP_API_ID_hipArray3DCreate = 70,
  HIP_API_ID_hipIpcOpenMemHandle = 71,
  HIP_API_ID_hipGetLastError = 72,
  HIP_API_ID_hipCtxDestroy = 73,
  HIP_API_ID_hipDeviceGetSharedMemConfig = 74,
  HIP_API_ID_hipSetDeviceFlags = 75,
  HIP_API_ID_hipFree = 76,
  HIP_API_ID_hipDeviceGetAttribute = 77,
  HIP_API_ID_hipMemcpyDtoH = 78,
  HIP_API_ID_hipCtxDisablePeerAccess = 79,
  HIP_API_ID_hipDeviceGetByPCIBusId = 80,
  HIP_API_ID_hipIpcGetMemHandle = 81,
  HIP_API_ID_hipMemcpyHtoDAsync = 82,
  HIP_API_ID_hipCtxGetDevice = 83,
  HIP_API_ID_hipMemcpyDtoD = 84,
  HIP_API_ID_hipModuleLoadData = 85,
  HIP_API_ID_hipDeviceTotalMem = 86,
  HIP_API_ID_hipCtxSetCurrent = 87,
  HIP_API_ID_hipMallocHost = 88,
  HIP_API_ID_hipDevicePrimaryCtxRetain = 89,
  HIP_API_ID_hipDeviceDisablePeerAccess = 90,
  HIP_API_ID_hipStreamCreateWithFlags = 91,
  HIP_API_ID_hipMemcpyFromArray = 92,
  HIP_API_ID_hipMemcpy2DAsync = 93,
  HIP_API_ID_hipEventCreateWithFlags = 94,
  HIP_API_ID_hipStreamQuery = 95,
  HIP_API_ID_hipDeviceGetPCIBusId = 96,
  HIP_API_ID_hipMemcpy = 97,
  HIP_API_ID_hipPeekAtLastError = 98,
  HIP_API_ID_hipHostAlloc = 99,
  HIP_API_ID_hipStreamAddCallback = 100,
  HIP_API_ID_hipMemcpyToArray = 101,
  HIP_API_ID_hipDeviceSynchronize = 102,
  HIP_API_ID_hipDeviceGetCacheConfig = 103,
  HIP_API_ID_hipMalloc3D = 104,
  HIP_API_ID_hipPointerGetAttributes = 105,
  HIP_API_ID_hipMemsetAsync = 106,
  HIP_API_ID_hipMemcpyToSymbol = 107,
  HIP_API_ID_hipCtxPushCurrent = 108,
  HIP_API_ID_hipMemcpyPeer = 109,
  HIP_API_ID_hipEventSynchronize = 110,
  HIP_API_ID_hipMemcpyDtoDAsync = 111,
  HIP_API_ID_hipCtxEnablePeerAccess = 112,
  HIP_API_ID_hipMemcpyDtoHAsync = 113,
  HIP_API_ID_hipModuleLaunchKernel = 114,
  HIP_API_ID_hipModuleGetTexRef = 115,
  HIP_API_ID_hipDeviceGetLimit = 116,
  HIP_API_ID_hipModuleLoadDataEx = 117,
  HIP_API_ID_hipRuntimeGetVersion = 118,
  HIP_API_ID_hipGetDeviceProperties = 119,
  HIP_API_ID_hipFreeArray = 120,
  HIP_API_ID_hipDevicePrimaryCtxRelease = 121,
  HIP_API_ID_hipHostGetDevicePointer = 122,
  HIP_API_ID_hipMemcpyParam2D = 123,
  HIP_API_ID_hipModuleGetFunction = 124,
...
#define INIT_hipMemcpyPeerAsync_CB_ARGS_DATA(cb_data) { \
  ...
  cb_data.args.hipMemcpyPeerAsync.dstDevice = (int)dstDevice; \
  ...
  switch (id) {
    ...
    case HIP_API_ID_hipMemcpyPeerAsync:
      oss << "hipMemcpyPeerAsync("
          ...
          << " dstDevice=" << data->args.hipMemcpyPeerAsync.dstDevice << ","
