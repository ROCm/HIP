...
hipError_t hipBindTextureToArray(textureReference* tex, hipArray_const_t array,
    ...
    // TODO: hipReadModeElementType is default.
    hip_status =
        ihipBindTextureToArrayImpl(hipTextureType2D, hipReadModeElementType, array, *desc, tex);
    return ihipLogStatus(hip_status);
}
...
hipError_t hipTexRefSetArray(textureReference* tex, hipArray_const_t array, unsigned int flags) {
    ...
    hip_status = ihipBindTextureToArrayImpl(hipTextureType2D, hipReadModeElementType, array,
                                            array->desc, tex);
    return ihipLogStatus(hip_status);
}
